namespace MiniORM
{
    ...
    public abstract class DbContext
    {
        ...
        {
            var dbSets = this.dbSetProperties.Values
            ...
            where TEntity : class, new()
        {
            ...
            var modifiedEntites = dbSet.ChangeTracker.GetModifiedEntities(dbSet);
        ...
        private void InitializeDbSets()
        {
            foreach (var dbSet in this.dbSetProperties)
            {
                ...
                var popluateDbSetGeneric = typeof(DbContext)
                    .GetMethod("PopulateDbSet", BindingFlags.Instance | BindingFlags.NonPublic)
                    .MakeGenericMethod(dbSetType);

                popluateDbSetGeneric.Invoke(this, new object[] { dbSetProperty });
            }
        }
